...
public class PaymentListener {
    ...
    public void onReservationRequested(@Valid ReservationRequestedEvent event) {
...
//            }
    ...
    public void onReservationCancelled(ReservationCancelledEvent event) {
        ...
        try {
            paymentService.processReservationCancelled(event);
            log.info("PaymentListener: Successfully processed ReservationCancelled: {}", event.reservationId());
        } catch (Exception ex) {
            log.error("PaymentListener: Error processing ReservationRequested for reservation {}: {}",
                    event.reservationId(), ex.getMessage(), ex);
